        ...
        try:
            ...
            for i, r in enumerate(records[:10], 1):
                ...
                if strength is None:
                    ...
                    lines.append(f"{i}. {sym} | Skor: {score_txt} ({int(strength)}/100) | Entry: {entry}")
                if why:
                    lines.append(f"   -> {why}")
                if reason:
...
def setup_telegram_bot():
    ...
    print()
    print("3️⃣ **Kodu Güncelle:**")
    print("   telegram_config.py dosyasını düzenle")
    print()
...
# Bot bilgilerinizi buraya girin
...
'''
    ...
    print("✅ telegram_config.py dosyası oluşturuldu!")
    print("📝 Bu dosyayı bot bilgilerinizle güncelleyin.")
