...
class TestRecordSignal:
    ...
    def test_max_signals_cap(self):
        from core.kpi_tracker import MAX_SIGNALS, get_recent_signals, record_signal
...
class TestRecordOutcome:
    def test_win_updates_outcome(self):
        from core.kpi_tracker import get_recent_signals, record_outcome, record_signal
...
class TestMarkSignalAutoApproved:
    def test_returns_true_on_success(self):
        from core.kpi_tracker import mark_signal_auto_approved, record_signal
    ...
    def test_flag_persisted(self):
        from core.kpi_tracker import get_recent_signals, mark_signal_auto_approved, record_signal
...
class TestGetKpis:
    ...
    def test_returns_zeros_when_no_resolved_signals(self):
        from core.kpi_tracker import get_kpis, record_signal
...
class TestSelfEvaluate:
    def test_grade_a_on_healthy_system(self):
        from core.kpi_tracker import record_outcome, record_signal, self_evaluate
    ...
    def test_recommendations_generated_for_low_win_rate(self):
        ...
        result = self_evaluate({"errors": []})
        assert any(
            "win rate" in r.lower() or "win_rate" in r.lower() or "oran" in r.lower()
            for r in result["recommendations"]
        )

    def test_evaluation_stored_in_cycle_scores(self):
        from core.kpi_tracker import get_cycle_scores, self_evaluate
