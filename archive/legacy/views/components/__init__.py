...
_register("views.components.research", "get_ai_research")
_register(
...
if TYPE_CHECKING:
    ...
    from views.components.panels import (
        render_summary_panel as render_summary_panel,
    )
    from views.components.research import get_ai_research as get_ai_research  # noqa: F401
    from views.components.settings import (  # noqa: F401
        load_settingscard_markup as load_settingscard_markup,
    )
    from views.components.settings import (
