...
**Üretim tarihi:** 2026-05-11 12:50
...
### Strateji A (1000 simülasyon, 224 trade)
...
| Sharpe Oranı | -110.432 | -115.962 | -125.139 | -107.628 |
...
- Sharpe p-değeri: **0.195**
- Değerlendirme: ⚠️  Zayıf edge: şans payı yüksek

### Strateji B (1000 simülasyon, 237 trade)
...
| Sharpe Oranı | -6.164 | -6.101 | -6.466 | -6.019 |
| Max Drawdown (%) | -7.76 | -7.903 | — | -8.371 |
| Profit Factor | 0.368 | — | 0.368 | 0.368 |

**İstatistiksel Anlamlılık:**

- Getiri p-değeri: **1.0** (simülasyonların `100.0%`'i gerçek sonucu geçti)
- Sharpe p-değeri: **0.851**
...
---
*FinPilot Walk-Forward + Monte Carlo Engine v1.0 — 2026-05-11*
